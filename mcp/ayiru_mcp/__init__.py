...
user has to do to get cited external knowledge for `gh` (the MVP
catalog), with accepted answers preferred and review-pending answers
explicitly marked, without running a server.
